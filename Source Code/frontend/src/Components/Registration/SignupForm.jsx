...
const SignupForm = () => {
	const { isLoggedIn, setAndCheckExpiration, setName, setUid, role, setRole } =
	...
	return (
		<div>
			<div className="flex p-1 border border-gray-400 rounded-full gap-x-1 max-w-max">
				<button
				...
				<div className="flex gap-x-5 mt-[15px]">
					...
					<label>
						...
						<select
							...
							className="rounded-[0.2rem] w-full p-[4px] border border-gray-400 cursor-pointer"
						>
